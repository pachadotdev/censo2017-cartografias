...
finp <- list.files("cartografias-originales", recursive = T, full.names = T, pattern = "COMUNA.*shp$")
...
write_sf(comunas_15r, "cartografias-fusionadas/comunas_15r.shp", layer_options = "ENCODING=UTF-8")
write_sf(comunas_16r, "cartografias-fusionadas/comunas_16r.shp", layer_options = "ENCODING=UTF-8")
